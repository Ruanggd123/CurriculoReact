...
<head>
  ...
  <style>
    * { box-sizing: border-box; }
    html { -webkit-font-smoothing: antialiased; zoom: 0.96; }
    ...
    .resume-item { page-break-inside: avoid !important; break-inside: avoid !important; }
    h3.resume-section-title, .resume-section-title { page-break-after: avoid !important; break-after: avoid !important; }
    ...
    .watermark-layer {
        ...
        padding: 40px 60px; border-radius: 30px; opacity: 0.6;
    }
    .watermark-text {
        font-size: 60px; font-weight: 900; color: rgba(0, 0, 0, 0.15);
        text-transform: uppercase; font-family: sans-serif;
        letter-spacing: 5px; white-space: nowrap;
    }
    .watermark-sub {
        font-size: 24px; font-weight: 700; color: rgba(0, 0, 0, 0.15);
        margin-top: 10px; font-family: sans-serif; letter-spacing: 2px;
    }
  </style>
</head>
<body>
